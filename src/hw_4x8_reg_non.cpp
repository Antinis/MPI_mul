...
void calc_1x4(int *result, int *A, int *B, int len)
{
    ...
    for(int i=0; i<len; i++)
    {
        ...
        c00_reg+=a0_reg* *b0_ptr;
        c01_reg+=a0_reg* *b1_ptr;
        c02_reg+=a0_reg* *b2_ptr;
        c03_reg+=a0_reg* *b3_ptr;
        c04_reg+=a0_reg* *b4_ptr;
        c05_reg+=a0_reg* *b5_ptr;
        c06_reg+=a0_reg* *b6_ptr;
        c07_reg+=a0_reg* *b7_ptr;

        c10_reg+=a1_reg* *b0_ptr;
        c11_reg+=a1_reg* *b1_ptr;
        c12_reg+=a1_reg* *b2_ptr;
        c13_reg+=a1_reg* *b3_ptr;
        c14_reg+=a1_reg* *b4_ptr;
        c15_reg+=a1_reg* *b5_ptr;
        c16_reg+=a1_reg* *b6_ptr;
        c17_reg+=a1_reg* *b7_ptr;

        c20_reg+=a2_reg* *b0_ptr;
        c21_reg+=a2_reg* *b1_ptr;
        c22_reg+=a2_reg* *b2_ptr;
        c23_reg+=a2_reg* *b3_ptr;
        c24_reg+=a2_reg* *b4_ptr;
        c25_reg+=a2_reg* *b5_ptr;
        c26_reg+=a2_reg* *b6_ptr;
        c27_reg+=a2_reg* *b7_ptr;

        c30_reg+=a3_reg* *b0_ptr++;
        c31_reg+=a3_reg* *b1_ptr++;
        c32_reg+=a3_reg* *b2_ptr++;
        c33_reg+=a3_reg* *b3_ptr++;
        c34_reg+=a3_reg* *b4_ptr++;
        c35_reg+=a3_reg* *b5_ptr++;
        c36_reg+=a3_reg* *b6_ptr++;
        c37_reg+=a3_reg* *b7_ptr++;
    }
